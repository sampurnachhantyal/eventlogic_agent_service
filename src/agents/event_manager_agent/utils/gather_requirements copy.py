# supplier_suggestion_agent/utils/nodes.py
import json
import logging
...
Do not ask unnecessary questions or repeatedly confirm information already provided.

You can think of each content and its parts as something that needs to be procured or arranged for the event from one supplier. Each content can have multiple parts and preferred suppliers for the procurement process.
